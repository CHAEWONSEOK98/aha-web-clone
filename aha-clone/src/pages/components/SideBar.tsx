      ...
      <div className="bg-slate-100 pl-6 pr-4">
        ...
        <section className="mt-2 mb-5 flex justify-between">
          <article>
            ...
            <span className="text-xs text-black opacity-75">출석스탬프</span>
          </article>
          ...
          <article>
            ...
            <span className="text-xs text-black opacity-75">지식 프로필</span>
          </article>
          ...
          <article>
            ...
            <span className="text-xs text-black opacity-75">룰렛이벤트</span>
          </article>
          ...
          <article>
            ...
            <span className="text-xs text-black opacity-75">계정 설정</span>
          </article>
        </section>
